...
class CodeQrPage extends StatefulWidget {
  CodeQrPage({Key key}) : super(key: key);
                    ...
                    children: <Widget>[
                      TextField(
                        ...
                        decoration: InputDecoration(
                          ...
                          helperText:
                              'Porfavor genere la imagen QR.',
                          hintText: 'Por favor , ingrese su qrCode',
                      ...
                      TextField(
                        ...
                        decoration: InputDecoration(
                          ...
                          helperText:
                              'El barcode o qrcode puede ser escaneado en esta area.',
                          hintText:
                              'El barcode o qrcode puede ser desplegado en esta area',
                          hintStyle: TextStyle(fontSize: 15),
                          contentPadding:
                              EdgeInsets.symmetric(horizontal: 7, vertical: 15),
                        ),
            ...
            Container(
              child: Row(
                ...
                children: <Widget>[
                  ...
                  Text('  Generar Qrcode', style: TextStyle(fontSize: 15)),
                  Spacer(),
                            ...
                            onTap: () async {
                              ...
                              if (success) {
                                snackBar = new SnackBar(
                                    content:
                                        new Text('Existoso Preservacion!'));
                                Scaffold.of(context).showSnackBar(snackBar);
                              } else {
                                snackBar = new SnackBar(
                                    content: new Text('Fallo al guardar!'));
                              }
                            },
                            child: Text(
                              'pagar',
